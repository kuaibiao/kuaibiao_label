    ...
    <div class="wrapper-content">
        <div class="layout-content">
            <Row class="setting-user-header">
                ...
                <h1 class="project_name">{{task_id}} - {{task_name}}</h1>
                <!-- <div class="search_input">
                    <span>{{$t('admin_recommend')}}： <Button size="small" v-for="(item, index) in recomend_users" :key="index" @click="searchUser(item.nickname)">{{item.nickname}}</Button></span>
                    <Input v-model="keyword"
                           ...
                           style="width: 180px"
                    />
                    <Button type="primary" @click="changeKeyword">{{$t('admin_input_search')}}</Button>
                </div> -->
                <div style="float: right;height: 32px;line-height: 32px;margin-right: 10px;width: auto">
            ...
            <Row>
                ...
                >
                <div slot="footer">
                    <div class="user_count">{{$t('admin_allocated_number')}}： <strong>{{userCount}}</strong></div>
            ...
            $.ajax({
                ...
                success: (res) => {
                    ...
                    if (res.error) {
                        ...
                        this.userCount = res.data.task_user_count;
