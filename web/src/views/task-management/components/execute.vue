            ...
            columns: [
                                ...
                                scopedSlots: {
                                    content: () => {
                                        return h('span', {
                                            ...
                                            h('div', this.$t('admin_execute_passed')),
                                        ]);
                                    }
                                }
                            }, [
                                h('span', this.$t('admin_passed')),
                                h('Icon', {
                                    style: {
                                        marginLeft: '3px',
                                        marginTop: '1px',
                                ...
                                scopedSlots: {
                                    content: () => {
                                        return h('span', {
                                            ...
                                            h('div', this.$t('admin_execute_rejected')),
                                        ]);
                                    }
                                }
                            }, [
                                h('span', this.$t('admin_rejected')),
                                h('Icon', {
                                    style: {
                                        marginLeft: '3px',
                                        marginTop: '1px',
                                ...
                                scopedSlots: {
                                    content: () => {
                                        return h('span', {
                                            ...
                                            h('div', this.$t('admin_execute_reseted')),
                                        ]);
                                    }
                                }
                            }, [
                                h('span', this.$t('admin_reseted')),
                                h('Icon', {
                                    style: {
                                        marginLeft: '3px',
                                        marginTop: '1px',
                ...
                },
                {
                    ...
                    children: [
                        ...
                        {
                            title: this.$t('operator_point'),
                            key: 'point_count',
                            align: 'center',
                        },
                        {
                            title: this.$t('operator_line'),
                            key: 'line_count',
                            align: 'center',
                        },
                        {
                            title: this.$t('operator_rectangle'),
                            key: 'rect_count',
                            align: 'center',
                        },
                        {
                            title: this.$t('operator_polygon'),
                            key: 'polygon_count',
                            align: 'center',
                        },
                        {
                            title: this.$t('operator_other'),
                            key: 'other_count',
                            align: 'center',
                        },
                        {
                                        ...
                                        scopedSlots: {
                                            content: () => {
                                                return h('span', {
                                                    ...
                                                    h('div', this.$t('admin_speech')),
                                                ]);
                                            }
                                        }
                                    }, [
                                        h('span', this.$t('operator_operation_time')),
                                        h('Icon', {
                                            style: {
                                                marginLeft: '3px',
                                                marginTop: '1px',
