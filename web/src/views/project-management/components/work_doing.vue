    ...
    export default {
        ...
        data () {
            return {
                ...
                tableOption: [
                    ...
                    {
                        title: this.$t('admin_time_remaining'),
                        key: 'data_name',
                        align: 'center',
                        maxWidth: 140,
                        render: (h, para) => {
                            let time = para.row.start_time * 1 + para.row.delay_time * 1 - this.currTime * 1;
                            time = time >= 0 ? time : 0;
                            return h('span', {}, time);
                        },
                            ...
                            return h('div', [
                                h('div', [
                                    h('Poptip', {
                                        ...
                                        h('span', this.$t('admin_time_remaining')),
                                        h('Icon', {
                                            style: {
                                                marginLeft: '3px',
                                                marginTop: '1px',
        ...
        methods: {
            ...
            changeCatrgoryFilter (operatorMap) {
                ...
                let userId = this.tableOption[index];
                userId.filters = operatorMap;
                // hack 动态filter
                Vue.nextTick(() => {
                    if (this.user_id !== '') {
