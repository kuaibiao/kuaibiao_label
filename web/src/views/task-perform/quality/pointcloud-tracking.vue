<template>
    <div style="position:relative; min-height: 100%;">
        ...
        <Modal v-model="viewModal"
               ...
               :transition-names="[]"
        >
            <pointcloud-tracking-audit-view
                    :taskList = "tableData"
...
<script>
    ...
    export default {
        name: 'quality-pointcloud-tracking',
        mixins: [commonMixin],
        props: {
            templateInfo: {
                type: Array,
        ...
        components: {
            ...
            'pointcloud-tracking-audit-view': () => import('components/task-audit-view/pointcloud-tracking-audit-view.vue'),
            'task-info': TaskInfo,
