        ...
        <Modal v-model="editModal"
            ...
            <div slot="header" class="edit-modal-header">
                ...
                <div class="edit-btn-group">
                    ...
                    <Button @click="editModal = false" size="small">{{$t('tool_cancel')}}</Button>
                </div>
            </div>
            <template-view
                    :config="templateInfo"
...
<script>
    ...
    import resultItemAnalysis from '../components/text-analysis-result.vue';
    ...
    export default {
                ...
                $.ajax({
                    ...
                    success: (res) => {
                        ...
                        if (res.error) {
                            ...
                            // this.executeTask(this.dataId , res.data.subject);
                        }
                    },
                    error: (res) => {
                        this.loading = false;
        ...
        components: {
            VideoAuditView: () => import("../../../common/components/task-audit-view/video-audit-view"),
