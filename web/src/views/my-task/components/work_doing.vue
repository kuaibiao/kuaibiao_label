    ...
    data () {
        return {
            ...
            tableOption: [
                ...
                {
                    title: this.$t('operator_remaining_effective_time'),
                    key: 'delay_time',
                    align: 'center',
                    // maxWidth: 140,
                    render: (h, para) => {
                        let time = parseInt(para.row.start_time) + parseInt(para.row.delay_time) - parseInt(this.currTime);
                        time = time >= 0 ? time : 0;
                        return h('span', time);
                    },
                    renderHeader: (h, params) => {
                        return h('span', [
                            h('Poptip', {
                                ...
                                h('span', this.$t('operator_remaining_effective_time')),
                                h('Icon', {
                                    style: {
                                        marginLeft: '3px',
                                        marginTop: '1px',
