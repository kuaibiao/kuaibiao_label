...
<template>
    <div ref="scrollCon" @DOMMouseScroll="handlescroll" @mousewheel="handlescroll" class="tags-outer-scroll-con">
        <div class="close-all-tag-con">
            ...
            <div v-on:click="handleTagsOption" class="close-tag-content">
                <span v-if="showAnimate">
                    <Tooltip :transfer="true" content="关闭标签" placement="right-end">
                        <Icon type="ios-close-circle-outline"></Icon>
                    </Tooltip>
                </span>
                <span v-if="!showAnimate">
                    <Spin fix>
                        <Icon type="ios-sync" size=18 class="demo-spin-icon-load"></Icon>
                    </Spin>
                </span>
            </div>
        </div>
