    ...
    <div class="template-instance" :path="path" :data-id="config.id" :data-tpl-type="config.type"
        ...
        <div class="instance-container" v-if="mode !== 'icon'">
            ...
            <div class="bone-container">
                <img :src="formatUrl(currentKeyPointItem.exampleImageSrc)" :alt="$t('template_key_points')"
                     class="example-img"
    ...
    export default {
        ...
        watch: {
            ...
            config: function (newValue) {
                if (this.currentKeyPointIndex >= newValue.data.length) {
                    this.currentKeyPointIndex = 0;
                }
                this.currentKeyPointItem = Object.assign({}, newValue.data[this.currentKeyPointIndex]);
                // this.$forceUpdate();
            }
        },
        created () {
