...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            isVoiceClassify () {
                return this.categoryView === 'voice_classify';
            }
        },
        mounted () {
        ...
        methods: {
            ...
            updateVoiceViewer (index) {
                let voiceUrl = this.taskListCopy[index].resource;
                this.audioSegment && this.audioSegment.pause();
                this.initAudioSegment(voiceUrl, this.result.data);
            },
            ...
            getResource (index) {
                ...
                if (this.taskListCopy[index] && this.taskListCopy[index].resource) {
                    this.$store.commit('changeGetBase64Process', 100);
                    this.updateVoiceViewer(index);
                    return;
                }
                ...
                $.ajax({
                    ...
                    success: (res) => {
                        if (res.error) {
                            ...
                            this.taskListCopy[index].resource = voice;
                            this.updateVoiceViewer(index);
                        }
                    },
                    error: () => {
