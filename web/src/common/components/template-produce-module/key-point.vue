    ...
    <div class="template-instance" :path="path" :data-id="config.id" :data-tpl-type="config.type"
        ...
        <div class="instance-container" v-if="mode !== 'icon'">
            ...
            <div class="bone-container">
                <img :src="config.exampleImageSrc | formatUrl" :alt="$t('tool_schematic_key_points')"
                     class="example-img">
                <span class="form-btn point-item "
                      ...
                      :data-text="item.text">{{index + 1}}</span>
            </div>
...
<script>
    ...
    export default {
        ...
        mounted () {
            ...
            this.keyPointTotalPointNumber = this.config.data.length;
            this.keyPointEqualDiversionConfig = this.config.equalDiversionConfig;
        ...
        methods: {
            ...
            setDefaultLabel () {
                EventBus.$emit('setDefaultLabel', {
                    ...
                    shortValue: this.config.data[this.activeIndex].text,
                    color: this.config.data[this.activeIndex].color || '#ffff00',
                }, true
                );
            },
            itemStyle: (position) => {
