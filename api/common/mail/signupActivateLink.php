...
$str = Yii::t('app', 'email_signup_content');
//ai平台,且语言为英文
if(trim($platform) == 'ai' && Yii::$app->language = 'en')
{
    $str = Yii::t('app', 'email_signup_content_ai');
}
...
<div class="container">
    ...
    <div class="main-content">
        <?php
            ...
            if(trim($platform) == 'ai' && Yii::$app->language = 'en')
            {
                echo sprintf($str, $email, $link, Html::a(Html::encode($link), $link), round($expire / 3600));
            ...
            {
                echo sprintf($str, $email, round($expire / 3600), $link, Html::a(Html::encode($link), $link));
