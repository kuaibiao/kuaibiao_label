...
$message = Yii::t('app', 'email_project_set_assign_notice');

$platform = Setting::getSetting('platform');
//ai平台,且语言为英文
if(trim($platform) == 'ai' && Yii::$app->language = 'en')
{
    $message = Yii::t('app', 'email_project_set_assign_notice_ai');
}

echo sprintf($message, $project_name, $link);
...
if(trim($platform) == 'ai' && Yii::$app->language = 'en')
{
    ...
    echo sprintf(Yii::t('app', 'email_project_set_income_notice_ai'), $logobase64);
