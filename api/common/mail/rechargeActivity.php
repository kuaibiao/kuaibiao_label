...
$message = Yii::t('app', 'email_recharge_activity_content');

$platform = Setting::getSetting('platform');
//ai平台,且语言为英文
if(trim($platform) == 'ai' && Yii::$app->language = 'en')
{
    $message = Yii::t('app', 'email_recharge_activity_content_ai');
}

echo sprintf($message, $activityContent);

//邮箱签名
if(trim($platform) == 'ai' && Yii::$app->language = 'en')
{
    echo Yii::t('app', 'email_company_sign_ai');
