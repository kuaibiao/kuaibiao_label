...
class ForbiddenWord extends Component
{
     ...
     *
     */
    public static function checkForbiddenWord($word)
    {
        $forbidden_words = self::getForbiddenWords();
        $newword = str_replace($forbidden_words, '', $word, $forbidden_count);
        if ($forbidden_count)
        {
            Yii::error(__CLASS__.' '.__FUNCTION__.' '.__LINE__. ' forbidden_word count '.JsonHelper::json_encode_cn([$newword, $forbidden_count, $word]));
        }
     ...
     * @return mixed
     */
    public static function replaceForbiddenWord($word, $replaceStr = '*')
    {
        $forbidden_words = self::getForbiddenWords();
        $newword = str_replace($forbidden_words, $replaceStr, $word, $forbidden_count);
        if ($forbidden_count)
        {
            Yii::error(__CLASS__.' '.__FUNCTION__.' '.__LINE__. ' forbidden_word count '.JsonHelper::json_encode_cn([$newword, $forbidden_count, $word, $replaceStr]));
        }
