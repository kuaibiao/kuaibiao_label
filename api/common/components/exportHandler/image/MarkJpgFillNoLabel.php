 ...
 */
class MarkJpgFillNoLabel extends Component
{
    ...
    public static function run($args){
        ...
        $batchDirname = Yii::t('app', 'pack_script_mark_image_fill_without_tag').'_'.$projectId.'_'.implode(',', $batchIds).'_'.date('YmdHis');
